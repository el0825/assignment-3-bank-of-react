...
class App extends Component {
  ...
  addCredit = (newCredit) => {
    ...
    const newCreditBalance = [...this.state.credits, newCredit]

    const newBalance = (parseFloat(this.state.accountBalance)+newCredit.amount).toFixed(2);
  ...
  render() {  
    ...
    const DebitsComponent = () => (<Debits debits={this.state.debits} addDebit={this.addDebit} balance={this.state.accountBalance} />) 
